        ...
        <div class="row" style="justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
          <div style="flex: 1; min-width: 250px;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 2px;">
              <div class="card-title" style="margin: 0;">${t("usage.loadingTitle")}</div>
              <span style="
                display: inline-flex;
                align-items: center;
                gap: 6px;
    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
      <div class="usage-header-row">
        <div class="usage-header-title">
          ...
          ${
            isEmpty
              ? html`
                  <span class="usage-query-hint">${t("usage.selectRangeHint")}</span>
                `
              : nothing
          }
        </div>
            ...
            displayTotals
              ? html`
                ...
                <span class="usage-metric-badge">
                  ...
                  ${t("usage.sessionsCount", { count: String(displaySessionCount) })}
                </span>
              `
              : nothing
          }
      ...
      <div class="usage-header-row">
        <div class="usage-controls">
          ...
          >
            <option value="local">${t("usage.localTime")}</option>
            <option value="utc">${t("usage.utcTime")}</option>
          </select>
