...
const SECURITY_OPTIONS: Array<{ value: ExecSecurity; label: string }> = [
  { value: "deny", label: "nodes.execApprovals.securityMode.deny" },
  { value: "allowlist", label: "nodes.execApprovals.securityMode.allowlist" },
  { value: "full", label: "nodes.execApprovals.securityMode.full" },
];

const ASK_OPTIONS: Array<{ value: ExecAsk; label: string }> = [
  { value: "off", label: "nodes.execApprovals.askMode.off" },
  { value: "on-miss", label: "nodes.execApprovals.askMode.onMiss" },
  { value: "always", label: "nodes.execApprovals.askMode.always" },
];
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        ...
        <button
          ...
          @click=${state.onSave}
        >
          ${state.saving ? t("nodes.saving") : t("common.save")}
        </button>
      </div>
    ...
    <div class="list" style="margin-top: 12px;">
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${t("nodes.execApprovals.targetSubtitle")}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
    ...
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults
              ? t("nodes.execApprovals.defaultSecurityMode")
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.execApprovals.askFallbackSubtitle")
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.execApprovals.autoAllowSkillsSubtitle")
                : autoIsDefault
                  ? t("nodes.execApprovals.usingDefault", {
                      value: defaults.autoAllowSkills
                        ? t("nodes.execApprovals.toggleOn")
                        : t("nodes.execApprovals.toggleOff"),
                    })
                  : t("nodes.execApprovals.overrideValue", {
                      value: autoEffective
                        ? t("nodes.execApprovals.toggleOn")
                        : t("nodes.execApprovals.toggleOff"),
                    })
        ...
        <div class="list-meta">
          ...
          ${
            !isDefaults && !autoIsDefault
              ...
              >
                ${t("nodes.execApprovals.useDefaultButton")}
              </button>`
              : nothing
          }
        </div>
  ...
  return html`
    ...
    <div class="list" style="margin-top: 12px;">
      ${
        entries.length === 0
          ? html`
              <div class="muted">${t("nodes.execApprovals.allowlistEmpty")}</div>
            `
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">${t("nodes.execApprovals.lastUsed", { value: lastUsed })}</div>
