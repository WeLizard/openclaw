...
function renderPairedDevice(device: PairedDevice, props: NodesProps) {
  ...
  const roles = t("nodes.devices.roles", { value: formatList(device.roles) });
  const scopes = t("nodes.devices.scopes", { value: formatList(device.scopes) });
...
function renderTokenRow(deviceId: string, token: DeviceTokenSummary, props: NodesProps) {
  ...
  const scopes = t("nodes.devices.scopes", { value: formatList(token.scopes) });
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        ...
        <button
          ...
          @click=${state.onSave}
        >
          ${state.configSaving ? t("nodes.saving") : t("common.save")}
        </button>
      </div>
              ...
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${
                    !supportsBinding
                      ? html`
                          <div class="muted">${t("nodes.bindings.noRunnableNodes")}</div>
                        `
                      : nothing
                  }
                </div>
        ...
        <div class="list-sub">
          ...
          ${
            bindingValue === "__default__"
              ? t("nodes.bindings.usesDefault", { value: state.defaultBinding ?? t("nodes.bindings.any") })
