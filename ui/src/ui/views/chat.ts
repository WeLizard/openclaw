...
function renderFallbackIndicator(status: FallbackIndicatorStatus | null | undefined) {
  ...
  const details = [
    ...
    phase === "cleared"
      ? t("chat.fallbackActive", { value: status.selected })
  ...
  const message =
    phase === "cleared"
      ...
      : t("chat.fallbackActivated", { value: status.active });
  const className =
    phase === "cleared"
          ...
          ? html`
            <div class="chat-queue" role="status" aria-live="polite">
              <div class="chat-queue__title">
                ${t("chat.queuedCount", { count: String(props.queue.length) })}
              </div>
        ...
        <div class="chat-compose__row">
          ...
          <div class="chat-compose__actions">
            ...
            <button
              ...
              @click=${props.onSend}
            >
              ${isBusy ? t("chat.queueAction") : t("chat.send")}<kbd class="btn-kbd">↵</kbd>
            </button>
          </div>
        </div>
      </div>
