...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "Kanal-, Nachrichten- und Audio-Einstellungen.",
    appearance: "Theme-, UI- und Einrichtungsassistent-Einstellungen.",
    automation: "Befehle, Hooks, Cron und Plugin-Einstellungen.",
    infrastructure: "Gateway-, Web-, Browser- und Medieneinstellungen.",
    aiAgents: "Agenten-, Modell-, Skill-, Tool-, Speicher- und Sitzungseinstellungen.",
