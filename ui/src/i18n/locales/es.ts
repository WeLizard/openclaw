...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "Ajustes de canales, mensajería y audio.",
    appearance: "Ajustes de tema, interfaz y asistente de configuración.",
    automation: "Ajustes de comandos, hooks, cron y plugins.",
    infrastructure: "Ajustes de gateway, web, navegador y medios.",
    aiAgents: "Ajustes de agentes, modelos, habilidades, herramientas, memoria y sesiones.",
